...
func (client *Client) Zrangewithscores(key string, start int, end int) ([][]byte, error) {
...
func (client *Client) Zrevrangewithscores(key string, start int, end int) ([][]byte, error) {
